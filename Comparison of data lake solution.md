...
The above are only obvious differences in some technical details. For example, Hudi supports Merge On Read tables and incremental queries. Iceberg is highly abstract and can define a self-describing schema. And delta is more integrated with spark and so on.
...
### Detailed Comparison
|                   | Alibaba Cloud EMR on ECS                                                                              | Alibaba Cloud EMR on ECS (Spark version)                        | Azure Databricks                                   |
| ----------------- | ----------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- | -------------------------------------------------- |
| CI/CD             | Unsupported                                                                                           | Supported                                                       | Supported                                          |
| Notebook          | Self-contained                                                                                        | Self-built                                                      | Self-contained                                     |
| Document          | Less                                                                                                  | Depends on open source components                               | Detailed                                           |
| Ease of Use       | Out of the box                                                                                        | Most components need to be self-built                           | Out of box                                         |
| Elastic Expansion | Scale by time or load                                                                                 | Scale by load/task                                              | Supported                                          |
| Task Scheduling   | Depends on DataWorksB<br />Support drag and drop                                                      | Self-built Airflow<br />Dragging requires additional components | Self-contained<br />Support drag and drop and code |
| Data Security     | Depends on DataWorks<br />Permission/Hierarchical Classification/Privacy Data Protection/Risk Warning | Self-built, Functions added on demand                           | Self-contained<br />                               |
